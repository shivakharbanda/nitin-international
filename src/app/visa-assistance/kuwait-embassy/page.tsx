...
export default function KuwaitEmbassyVisaPage() {
  return (
    <>
      <PageHeader
        icon={Building}
        title="Kuwait Embassy Visa Assistance"
        description="Nitin International provides comprehensive support for all visa application and document attestation procedures pertaining to the Embassy of the State of Kuwait, New Delhi."
      />
